    ...
    <div class="row">
        ...
        <div class="col-md-2 navigation-navbar rounded-end-4 vh-100 position-fixed">
            <div class="nav-header">
                <a href="http://localhost/W3CMS/sourceCode/User/" class="brand-href">
            ...
            <div class="navigationBar vh-100 fs-small overFlow-y menu">
                    ...
                    <li class="nav-item">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menuer fs-small">
                                ...
                                <div class="dropdown-menuer fs-small pb-2">
                                    <a class="dropdown-item" href="http://localhost/W3CMS/sourceCode/Blogs/">Blog</a>
                ...
                <p class=" text-muted fs-0 text-center" href="#">Made width<span class="heart"></span> by DexignZone</p>
            </div>
        </div>
