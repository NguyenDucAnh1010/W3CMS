    ...
    <div class="bg-none">
        <div class="page bg-white ps-5 pe-5 mt-5">
            ...
            <div class="ShowPage mt-5">
                <form action="../Post/post_edit_blog.php?id=<?php echo $id;?>" method="post">
                    <div class="row">
                        <span>tittle</span>
                        <input type="text" name="tittle" id="tittle" value="<?php echo $username; ?>">
                    </div>
                    <div class="row">
                        <span>Created At</span>
                        <input type="text" name="created_at" id="created_at" value="<?php echo $email; ?>">
                    </div>
                    <button type="submit">save</button>
                    <a class="btn" href="http://localhost/W3CMS/sourceCode/Blogs/">cancel</a>
                </form>
            </div>
        </div>
    </div>
